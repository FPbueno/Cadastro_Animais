...
import router from "./routes/animalRoutes";
...
app.use("/api", router); // Rota principal para as despesas

// URI do MongoDB (pega do arquivo .env ou usa um padrão local)
const uri = process.env.MONGO_URI || "mongodb://localhost:27017/AnimalDatabase";
